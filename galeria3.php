...
<head>
    ...
    <title>Morabito Knives | San Mai </title>
</head>

<body>

    <main class="home">
        <?php include("portadaGaleria3.php") ?>
        <div class="header">
                            ...
                            <div class="col-sm-12 pb-4">
                                ...
                                <div id="carouselNovedades" class="owl-carousel owl-theme">
                                    ...
                                    try {
                                        ...
                                        $sql = $conexion->prepare("SELECT * FROM productos WHERE tipo = 'San Mai Gyuto' ORDER BY id DESC");
                                        $sql->execute();
