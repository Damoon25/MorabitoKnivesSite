...
<body>
    ...
    <main>
        <div class="home">
            <?php include("portadaHomeEN.php") ?>
            <div class="header">
                <?php include("templateEN/header2.php") ?>
            </div>
            <div class="col-sm-12 text-center text-md-start">
                <div id="galeria" class="container">
                    <h2 class="titleSection paddingTop paddingBottom">My Gallery</h2>
                </div>
            </div>
            <div class="container">
                        ...
                        <div data-aos="zoom-in" class="card">
                            <div class="card-body">
                                ...
                                <div class="col-sm-12 pt-4 pb-4">
                                    <h3 class="card-title text-center">Damascus Steel</h5>
                                </div>
                                <div class="col-sm-12">
                                    <div class="d-flex justify-content-center paddingBottom">
                                        <a href="gallery1.php" class="btn2">View Gallery</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-4 d-flex justify-content-center align-items-center ">
                        <div data-aos="zoom-in" class="card">
                            <div class="card-body">
                                ...
                                <div class="col-sm-12">
                                    <div class="d-flex justify-content-center paddingBottom">
                                        <a href="gallery2.php" class="btn2">View Gallery</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-4 d-flex justify-content-center align-items-center ">
                        <div data-aos="zoom-in" class="card">
                            <div class="card-body">
                                ...
                                <div class="col-sm-12">
                                    <div class="d-flex justify-content-center paddingBottom">
                                        <a href="gallery3.php" class="btn2">View Gallery</a>
                                    </div>
                                </div>
                            </div>
                        </div>
