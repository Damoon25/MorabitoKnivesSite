...
<head>
    ...
    <title>Morabito Knives | Mono Steel</title>
</head>
...
<body>
    ...
    <main>
        <div class="home">
            <?php include("portadaGaleria2.php") ?>
            <div class="header">
                                ...
                                <div class="col-sm-12 pb-4">
                                    ...
                                    <div id="carouselNovedades" class="owl-carousel owl-theme">
                                        ...
                                        try {
                                            ...
                                            $sql = $conexion->prepare("SELECT * FROM productos WHERE tipo = 'Acero 5160' ORDER BY id DESC");
                                            $sql->execute();
