            ...
            <div class="offcanvas-body d-block d-lg-none text-start">
                <ul class="container navbar-nav me-auto ps-3">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link textoNav textCanvas animate__animated animate__backInRight animate__delay-1s animate__fast" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">GALLERY
                        </a>
