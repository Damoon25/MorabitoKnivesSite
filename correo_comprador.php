...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mailVendedor->addAddress('ventas@morabitoknives.com.ar'); // Dirección de correo electrónico de destino
        $mailVendedor->addReplyTo($email, $nombre);
        $mailVendedor->IsHTML(true);
        $mailVendedor->Subject = "Hola $nombre,\n\nGracias por tu compra.";
