        ...
        <div class="card-login rounded-4 " data-aos="flip-left">
            <div class="header-login">
                <div class="container-sm text-center pt-2 pb-2">
                    <h2 style="text-align:center; font-size:larger;color: var(--link)">CREA TU CUENTA</h2>
                </div>
            </div>
            <div class="body-login">
                <div class=" col-sm-12 col-md-12 d-flex justify-content-center align-self-center me-2">
                    <img src="../public/img/logoBlack.png" id="logoAdmin" alt="logo" class="img-fluid p-4">
                </div>
                <form method="POST" class="container-sm-fluid text-center">
                    ...
                    <div class="mb-4">
                        <button type="submit" id="login" class="boton-Login  btn-lg btn-primary rounded-pill btn-lg" name="accion" value="register">REGISTRARSE</button>
                        <div class="mt-3 mb-3">
                            <?php
